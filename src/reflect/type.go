...
type Type interface { // Type为对Go类型的表示
...
func TypeOf(i interface{}) Type { // 返回接口的类型，Type也是一个接口
	eface := *(*emptyInterface)(unsafe.Pointer(&i)) // 先转换为空接口类型
